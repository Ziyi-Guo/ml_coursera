...
data = scipy.io.loadmat('ex6data1.mat', matlab_compatible=True)
X = data['X']
y = data['y']
...
# Load from ex6data2:
# You will have X, y in your environment
data = scipy.io.loadmat('ex6data2.mat', matlab_compatible=True)
X = data['X']
y = data['y']
...
clf = SVC(C=C, kernel='rbf', tol=1e-3, max_iter=200, gamma=gamma)
model = clf.fit(X, y)
